...
export function main() {
  ...
  fetch("jscroot/template/content/Geo/chapter2/Data.json")
  ...
  const polygonGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/Data.json';
  const lineStringGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/Data.json';
  const pointGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/Data.json';
